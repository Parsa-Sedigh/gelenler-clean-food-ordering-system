...
-- to create the data in the materialized view:
...
-- this will refresh the data in the order_customer_m_view materialized view, whenever data is changed in the customers table.
