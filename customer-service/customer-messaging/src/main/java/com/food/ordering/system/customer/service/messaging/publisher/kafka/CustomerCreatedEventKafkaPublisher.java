...
public class CustomerCreatedEventKafkaPublisher implements CustomerMessagePublisher {
    ...
    /* Since we haven't use outbox pattern for simplicity in customer svc, we can't reuse the
     kafkaMessageHelper.getKafkaCallback() here, as we have set up that method to use outbox pattern. */
