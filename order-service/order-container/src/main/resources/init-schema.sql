...
ALTER TABLE "order".order_items
    ADD CONSTRAINT "FK_ORDER_ID" FOREIGN KEY (order_id)
        ...
        -- if we delete an order, the order items will be deleted automatically. Without the CASCADE option, a foreign key will
        -- prevent deleting the order when there is an item in the order_items table with that order_id.
        ON DELETE CASCADE
    NOT VALID;
