...
public class PaymentEventKafkaPublisher implements PaymentResponseMessagePublisher {
    ...
    /* the methods of the outboxCallback will be called after getting acknowledgment from kafka. So we only update the
    outbox table, when we get a response from kafka and we're sure that the message is reached to kafka. */
    @Override
       ...
       log.info("Received OrderOutboxMessage for order id: {} and saga id: {}",
        ...
        try {
            ...
            log.error("Error while sending PaymentResponseAvroModel message" +
                    " to kafka with order id: {} and sagaId: {}, error: {}",
