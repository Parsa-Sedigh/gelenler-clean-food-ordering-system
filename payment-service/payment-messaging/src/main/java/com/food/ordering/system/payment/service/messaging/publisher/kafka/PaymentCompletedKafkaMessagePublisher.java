...
//
//        /* Callback method will be called when the kafka producer gets a response from kafka cluster. Remember that KafkaProducer.send()
//        method is an async call, that's why we need a callback method here as we will not get a response immediately.*/
